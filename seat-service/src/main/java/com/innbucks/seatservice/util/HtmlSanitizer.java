 ...
 * stripAll removes ALL markup (plain-text fields); sanitizeRichText keeps a formatting
 * allowlist. Applied on write paths so stored data is safe regardless of how any client
 * renders it. Entities are decoded so "Tom &amp; Jerry" round-trips unchanged.
 */
