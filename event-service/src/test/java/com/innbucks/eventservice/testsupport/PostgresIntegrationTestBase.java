package com.innbucks.eventservice.testsupport;
...
@EnabledIf("com.innbucks.eventservice.testsupport.PostgresIntegrationTestBase#isDockerAvailable")
public abstract class PostgresIntegrationTestBase {

    @SuppressWarnings("resource")
    protected static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("event_it")
            .withUsername("event")
            .withPassword("event")
            .withReuse(true);
