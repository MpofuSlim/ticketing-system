 ...
 * double-conversion. The two share DTO classes — {@code BookingResponseDTO} is
 * returned by {@code GET /bookings/{id}} <em>and</em> by
 * {@code GET /bookings/internal/{id}} — so the audience cannot be a property of
 * the type. It is a property of the request, which is what this reads.
 *
