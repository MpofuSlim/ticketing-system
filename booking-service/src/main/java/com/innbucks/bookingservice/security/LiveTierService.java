 ...
 * outage.
 *
 * Uses RestClient (not Feign) deliberately — Feign's factory bean drags
 * WebMvc autoconfiguration into its construction and produces a circular
 * dependency with WebMvcConfig (which itself depends on the interceptor
