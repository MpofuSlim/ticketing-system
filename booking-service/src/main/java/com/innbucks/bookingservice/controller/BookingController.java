...
public class BookingController {
    ...
    @PreAuthorize("hasAnyRole('CUSTOMER','TENANT','ADMIN')")
    @Operation(
            ...
            description = "Returns every booking attached to the given phone number, most recent first. " +
                    ...
                    "Open to any authenticated CUSTOMER, TENANT, or ADMIN. " +
                    "Empty list if no bookings exist for the phone."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Missing/invalid JWT"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Authenticated but not CUSTOMER/TENANT/ADMIN")
    })
