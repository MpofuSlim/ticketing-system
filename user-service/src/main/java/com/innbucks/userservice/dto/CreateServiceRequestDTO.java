...
public class CreateServiceRequestDTO {
    ...
    @Schema(example = "marketplace",
            description = "Bundle name to request access to. Must be one of the known platform bundles ('ticketing', 'loyalty', 'marketplace').")
    private String service;

    @NotBlank(message = "reason is required")
    @Size(max = 1000, message = "reason must be 1000 characters or fewer")
    @Schema(example = "We want to sell our products on the InnBucks marketplace.",
